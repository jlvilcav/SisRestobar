...
<section id="croquis" class="withPanel" ng-if="vm.mode == 'croquis'">
  <!-- <div class="control">
      <span>Scale</span>
...
<section id="deliveryPanel" ng-if="vm.mode == 'croquis'" style="border-left: 1px solid #CCC; padding: 20px;">
  ...
  <ul id="deliveryList" ng-if="vm.deliverys">
    <li ng-repeat="dl in vm.deliverys" style="border-color: #eee; padding: 10px;">
      ...
      <div style="text-align: right;">
        ...
        <button class="btn btn-sm btn-default" ng-click="vm.loadPedido({pedido: dl.id})"><i class="fa fa-dollar"></i> Pagar D</button>
      </div>
    </li>
  </ul>
</section>
...
<section id="details" ng-if="vm.mode == 'details'">
    <div id="resumen" class="box">
        ...
        <div class="box__content" style="padding: 15px; background-color: #CBDDED;">
            <table class="table">
                <thead>
                    <tr style="background-color: #777; color: #DDD;">
                        <th>:: PRODUCTOS</th>
                        <th>:: CANTIDAD</th>
                        <th>:: COSTO</th>
                        <th></th> 
