<?php if ($this->session->userdata('s_idUsuario')) : ?>    
    ...
    <!-- Este metodo es para no ingresar comillas, o simbilos ajenos, no se usa porque malogra el funcionamiento de los datepickers -->
    <script type="text/javascript">
      // $('input[type=text]').keypress(function() {
      //   var regex = new RegExp("^[a-zA-Z0-9 ñÑ_-@]+$");
    ...
    <?php if($this->uri->segment(1)=='caperturacierre') {?> 
            <script src="<?php echo base_url(); ?>js/aperturacierre.js"></script>
    <?php }?>
    <?php if($this->uri->segment(1)=='creportes') {?> 
            <script src="<?php echo base_url(); ?>js/reportes.js"></script>
            <script src="<?php echo base_url(); ?>js/insconsumido.js"></script>
    <?php }?>
    <?php if($this->uri->segment(1)=='cinsumo') {?> 
